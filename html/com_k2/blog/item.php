...
<div id="k2Container" class="blog-item <?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php endif; ?>
		...
		<div class="blog-item__header-info">
			<div class="blog-item__header-info_inner">
				<?php if($this->item->params->get('itemAuthor')): ?>
				<!-- Item Author -->
				<span class="blog-item__header-info_author">
				...
				<span class="blog-item__header-info_separator">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
				<?php endif; ?>
				<?php if($this->item->params->get('itemDateCreated')): ?>
				<!-- Date created -->
				<span class="blog-item__header-info_created">
		...
		<div class="blog-item__header-tags">
	...
	<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
		<div class="blog-item__body-image">
		...
		<?php endif; ?>
		<div class="blog-item__body-content">
	...
	<div class="blog-item__actions">
		...
		<div class="blog-item__actions-category">
	...
	<!-- Item attachments -->
	<div class="blog-item__attachments">
	...
	<div class="blog-item__author">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 blog-item__author-image">	
				<img class="img-fluid" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
			</div>
			<?php endif; ?>
			<div class="col-xs-12 <?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>col-sm-8 col-md-9 col-lg-10<?php endif; ?> blog-item__author-info">
				...
				<span class="itemAuthorUrl"><i class="icon-globe"></i> <a rel="me" href="<?php echo str_replace('http://','',$this->item->author->profile->url); ?>">View Full Profile <i class="fa fa-chevron-right"></i></a></span>
				<?php endif; ?>
	...
	<div class="blog-item__authorlatest">
	...
	<div class="blog-item__related">
		...
		<?php foreach($this->relatedItems as $key=>$item): ?>
			<div class="col-xs-12 col-sm-6 col-md-3 <?php echo ($key%2) ? "odd" : "even"; ?>">
				...
				<div class="blog-item__related-image" style="background-image: url(<?php echo $item->image; ?>);">
					<a href="<?php echo $item->link ?>">
					<div class="blog-item__related-image_inner">
