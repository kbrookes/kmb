...
<div id="k2Container" class="general-item <?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">

	<div class="general-item__header">
	...
	<?php endif; ?>
		...
		<div class="general-item__header-info">
			<?php if($this->item->params->get('itemAuthor')): ?>
			<!-- Item Author -->
			<span class="general-item__header-info_author">
			...
			<span class="general-item__header-info_separator">&nbsp;&nbsp;||&nbsp;&nbsp;</span>
			<?php endif; ?>
			<?php if($this->item->params->get('itemDateCreated')): ?>
			<!-- Date created -->
			<span class="general-item__header-info_created">
		...
		<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
			<div class="general-item__body-image">
			...
			<?php endif; ?>
			<div class="general-item__body-content">
	...
	<div class="general-item__actions">
		<?php if($this->item->params->get('itemCategory')): ?>
		<div class="general-item__actions-category">
		...
		<!-- Item tags -->
		<div class="general-item__actions-tags">
	...
	<!-- Item attachments -->
	<div class="general-item__attachments">
	...
	<!-- Author Block -->
	<div class="general-item__author">
		<div class="row">
			<?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>
			<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 general-item__author-image">	
				<img class="img-fluid" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
			</div>
			<?php endif; ?>
			<div class="col-xs-12 <?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>col-sm-8 col-md-9 col-lg-10<?php endif; ?> general-item__author-info">
	...
	<div class="general-item__authorlatest">
	...
	*/
	...
	<div class="general-item__related">
	...
	<div class="itemNavigation d-flex justify-content-between">
		...
		<a class="itemPrevious btn btn-sm btn-outline-primary" href="<?php echo $this->item->previousLink; ?>">&laquo; <?php echo $this->item->previousTitle; ?></a>
		<?php endif; ?>
		
		<span class="itemNavigationTitle"><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?></span>

		<?php if(isset($this->item->nextLink)): ?>
		<a class="itemNext btn btn-sm btn-outline-primary" href="<?php echo $this->item->nextLink; ?>"><?php echo $this->item->nextTitle; ?> &raquo;</a>
		<?php endif; ?>
	</div>
	<?php endif; ?>
