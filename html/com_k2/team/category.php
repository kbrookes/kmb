...
<div id="k2Container" class="team-page <?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="category-wrap">
		...
		<!-- Subcategories -->
		<div class="team-page__categories category-wrap__subcats">
			...
			<div class="team-page__categories-subcat category-wrap__subcats-category container <?php echo $lastContainer; ?>">

					<?php if($this->params->get('subCatTitle')): ?>
					<h2 class="team-page__categories-subcat_title category-wrap__subcats-category_title"><?php echo $subCategory->name; ?></h2>
					<?php endif; ?>
					<?php if($this->params->get('subCatDescription')): ?>
					<!-- Subcategory description -->
					<div class="team-page__categories-subcat_description category-wrap__subcats-category_description">
