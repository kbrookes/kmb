...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="latest-items <?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
<?php if(count($items)): ?>
  <div class="row">
    <?php foreach ($items as $key=>$item):	?>
    <div class="latest-items__item col-12 <?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
	    <div class="row">
		    <?php if($params->get('itemImage') && isset($item->image)): ?>
		    <div class="col-xs-12 col-sm-4 col-md-3 latest-items__item-image">
